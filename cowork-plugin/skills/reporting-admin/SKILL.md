...
(async()=>{
  const base = "{baseUrl from config}";
  const key = "{functionKey from config}";
  const r = await fetch(`${base}/list_resources?resource_type=archive_item&filter=companyId eq 42`, {
    headers: {"x-functions-key": key}
  });
  return await r.text();
})()
...
(async()=>{
  const base = "{baseUrl from config}";
  const key = "{functionKey from config}";
  const r = await fetch(`${base}/get_resource?resource_type=archive_item&archive_id=10&id=55`, {
    headers: {"x-functions-key": key}
  });
  return await r.text();
})()
...
(async()=>{
  const base = "{baseUrl from config}";
  const key = "{functionKey from config}";
  const r = await fetch(`${base}/list_resources?resource_type=certificate&filter=companyId eq 42`, {
    headers: {"x-functions-key": key}
  });
  return await r.text();
})()
...
(async()=>{
  const base = "{baseUrl from config}";
  const key = "{functionKey from config}";
  const r = await fetch(`${base}/list_resources?resource_type=company_group`, {
    headers: {"x-functions-key": key}
  });
  return await r.text();
})()
...
(async()=>{
  const base = "{baseUrl from config}";
  const key = "{functionKey from config}";
  const r = await fetch(`${base}/list_resources?resource_type=quickstart`, {
    headers: {"x-functions-key": key}
  });
  return await r.text();
})()
...
(async()=>{
  const base = "{baseUrl from config}";
  const key = "{functionKey from config}";
  const r = await fetch(`${base}/list_resources?resource_type=media`, {
    headers: {"x-functions-key": key}
  });
  return await r.text();
})()
...
(async()=>{
  const base = "{baseUrl from config}";
  const key = "{functionKey from config}";
  const r = await fetch(`${base}/manage_tokens?action=list`, {
    headers: {"x-functions-key": key}
  });
  return await r.text();
})()
...
(async()=>{
  const base = "{baseUrl from config}";
  const key = "{functionKey from config}";
  const r = await fetch(`${base}/raw_api_call?method=GET&path=/v2/odata/company/$count`, {
    headers: {"x-functions-key": key}
  });
  return await r.text();
})()
