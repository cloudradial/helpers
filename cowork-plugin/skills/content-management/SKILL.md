...
- **List articles:**
  ...
  (async()=>{
    const base = "{baseUrl from config}";
    const key = "{functionKey from config}";
    const r = await fetch(`${base}/list_resources?resource_type=article&filter=companyId eq 42`, {
      headers: {"x-functions-key": key}
    });
    return await r.text();
  })()
...
- **Get article:**
  ...
  (async()=>{
    const base = "{baseUrl from config}";
    const key = "{functionKey from config}";
    const r = await fetch(`${base}/get_resource?resource_type=article&id=123`, {
      headers: {"x-functions-key": key}
    });
    return await r.text();
  })()
...
- **List catalogs:**
  ...
  (async()=>{
    const base = "{baseUrl from config}";
    const key = "{functionKey from config}";
    const r = await fetch(`${base}/list_resources?resource_type=catalog&filter=companyId eq 42`, {
      headers: {"x-functions-key": key}
    });
    return await r.text();
  })()
...
- **List menus:**
  ...
  (async()=>{
    const base = "{baseUrl from config}";
    const key = "{functionKey from config}";
    const r = await fetch(`${base}/list_resources?resource_type=menu&filter=companyId eq 42`, {
      headers: {"x-functions-key": key}
    });
    return await r.text();
  })()
...
- **List lessons for a course:**
  ...
  (async()=>{
    const base = "{baseUrl from config}";
    const key = "{functionKey from config}";
    const r = await fetch(`${base}/list_resources?resource_type=course_lesson&filter=courseId eq 372`, {
      headers: {"x-functions-key": key}
    });
    return await r.text();
  })()
...
1. **Confirm the target company:**
   ...
   (async()=>{
     const base = "{baseUrl from config}";
     const key = "{functionKey from config}";
     const r = await fetch(`${base}/search_companies?name=<company>`, {
       headers: {"x-functions-key": key}
     });
     return await r.text();
   })()
...
2. **Check existing articles** to avoid duplicates:
   ...
   (async()=>{
     const base = "{baseUrl from config}";
     const key = "{functionKey from config}";
     const r = await fetch(`${base}/list_resources?resource_type=article&filter=companyId eq <id>`, {
       headers: {"x-functions-key": key}
     });
     return await r.text();
   })()
